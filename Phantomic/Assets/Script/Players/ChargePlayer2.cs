...
public class ChargePlayer2 : MonoBehaviour
{
    public Text text1;
    ...
    public TeleportPoint ability1;
    public FireBall ability2;

    public void Start()
    {

        ability1 = FindObjectOfType<TeleportPoint>();
        ability2 = FindObjectOfType<FireBall>();
    ...
    public void Update()
    {
        //Ability1(); No activa ahora mesmo
        Ability2();
    }
    ...
    public void Ability2()
    {
        ...
        {
            cooldownText1.text = "" + 0 + "";
            ringHealthBar2.fillAmount = 1;
            cooldown2 = 0;
        }
    }
}
